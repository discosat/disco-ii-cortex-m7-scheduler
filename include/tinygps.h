...
Modification of fork: https://github.com/acassis/tinygps
*/
...
void gps_crack_datetime(int * year, unsigned char * month, unsigned char * day,
						unsigned char * hour, unsigned char * minute, unsigned char * second, unsigned char * hundredths, unsigned long * fix_age);
...
int gps_term_complete();
int gpsisdigit(char c);
