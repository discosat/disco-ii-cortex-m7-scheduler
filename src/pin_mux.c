...
- pin_list:
  ...
  - {pin_num: AJ5, peripheral: UART1, signal: uart_rx, pin_signal: UART1_RXD, PUE: Weak_Pull_Up, DSE: X6}
  - {pin_num: AH5, peripheral: UART1, signal: uart_tx, pin_signal: UART1_TXD, PUE: Weak_Pull_Up, DSE: X6}
