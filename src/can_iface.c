...
static int csp_can_tx_frame(void * driver_data, uint32_t id, const uint8_t * data, uint8_t dlc) {
	...
	for (uint8_t i = 0; i < dlc; i++) {
		switch (i) {
			case 0:
				txFrame.dataByte0 = data[i];
				break;
			case 1:
				txFrame.dataByte1 = data[i];
				break;
			case 2:
				txFrame.dataByte2 = data[i];
				break;
			case 3:
				txFrame.dataByte3 = data[i];
				break;
			case 4:
				txFrame.dataByte4 = data[i];
				break;
			case 5:
				txFrame.dataByte5 = data[i];
				break;
			case 6:
				txFrame.dataByte6 = data[i];
				break;
			case 7:
				txFrame.dataByte7 = data[i];
				break;
		}
	}
